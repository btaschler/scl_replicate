#' Prepare data for causal ancestral discovery (CAD)
#'
...
#' @export
#'
cad_process_data = function(obs_data, int_data, int_indices, G_star,
                            int_graph_count,
                            int_sample_count,
                            obs_sample_count,
    ...
    data = list(
        ...
        int_indices_sample = match(int_indices[int_sample_ids], jj)
    )
