...
```{r load_data, include=TRUE, cache=TRUE, message=FALSE}
...
```{r cad_vary_p, include=TRUE, cache=TRUE, message=FALSE, dependson='load_data'}
...
```{r gies_vary_p, include=TRUE, cache=TRUE, message=FALSE, dependson='load_data'}
...
```{r rfci_pc_vary_p, include=TRUE, cache=TRUE, message=FALSE, dependson='load_data'}
...
```{r ida_vary_p, include=TRUE, cache=TRUE, message=FALSE}
...
```{r setup_plotting, include=FALSE, cache=FALSE}
...
```{r plot_auc_entries, include=TRUE, echo=FALSE, fig.width=12, fig.height=10}
...
```{r plot_avg_roc_entries, include=TRUE, echo=FALSE, fig.width=10, fig.height=10}
...
```{r plot_auc_rows, include=TRUE, echo=FALSE, fig.width=12, fig.height=10}
...
```{r plot_avg_roc_rows, include=TRUE, echo=FALSE, fig.width=10, fig.height=10}
...
```{r plot_timings, include=TRUE, echo=FALSE, fig.width=10, fig.height=10}
tbl_time =
    tbl %>%
